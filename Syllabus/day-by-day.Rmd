...
* [Instructor's notes](../Notes/Day-01-notes.html).  These are merely my plans for the class session.  Plans don't always match the actual event.  Use these for review, or to orient yourself to a missed class.  Reading these is not a substitute for class attendance.
...
* Not ready yet.  Wait until this note is removed ... Quick survey to do **before** class: [link](https://spreadsheets.google.com/embeddedform?formkey=dEV1cW1rTWhpLUhITVFNVGpnQjNqT3c6MQ&theme=0AX42CRMsmRFbUy04ZWQwMDYwMS02YjZhLTQ2ZjMtYjcyNy0zYWNlMzlmYTAxNmY&embedded=true&ifq)
...
* Elevator experiment: Instructions `r I(PN(c(336),assignment="Elevator Data Collection",))`. -- Upload your file or a link to your file [here](https://moodle.macalester.edu/mod/assign/view.php?id=17379).FIX THIS LINK
