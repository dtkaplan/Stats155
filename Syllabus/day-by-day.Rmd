...
* Elevator experiment: Instructions FIX THIS LINK `r I(PN(c(336)))`. -- Upload your file or a link to your file [here](https://moodle.macalester.edu/mod/assign/view.php?id=17379).
* [Start-of-course knowledge survey FIX THIS LINK](https://dl.dropbox.com/u/5098197/Exercises/HTML/SM2-Statistics-Knowledge-Survey/SM2-Statistics-Knowledge-Survey-A.html?access=ISMf12)
...
* Extensions `r I(PN(c(620,621)),,assignment="Eight-Opt")`, [XKCD cartoon](http://xkcd.com/418/).  What regression model for this?
...
**Assignment**: `r I(PN(c(1301),assignment="Twenty"))`
...
**Assignment**: 
* `r I(PN(c("13RQ",1302),assignment="Twenty-one"))`
...
**Assignment**: `r I(PN(c(1401,1402),assignment="Twenty-two"))`
...
**Assignment**: `r I(PN(c("14RQ",1404,1405,1411,1412,1424),assignment="Twenty-three"))`
...
**Assignment**: `r I(PN(c("15RQ",1501),assignment="Twenty-four"))`
...
**Assignment**: `r I(PN(c(1502,1504,1505,1511),assignment="Twenty-five"))`
...
**Assignment**:  `r I(PN(c(1512,1521),assignment="Twenty-six"))`
...
**Assignment**: 
*`r I(PN(c(1522),,assignment="Twenty-seven"))`
...
**Assignment**: `r I(PN(c(),assignment="TwentyEight"))` BLANK FOR NOW
...
**Assignment**: 
* `r I(PN(c("16RQ",1601,1602,1604),assignment="Twenty-nine"))`
...
**Assignment**: `r I(PN(c(1605,1610,1612),assignment="Thirty"))`
...
**Assignment**: `r I(PN(c("17RQ",1701,1702,1705),assignment="Thirty-one"))`
...
**Assignment**: `r I(PN(c(1706,1707,1708,1710),"Thirty-two))`
