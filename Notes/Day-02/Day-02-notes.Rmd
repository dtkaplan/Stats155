...
Discussion of the [sleep and dementia] article to highlight some points that might be regarded as common sense.
...
* An intermediate type --- ordinal --- and give as example a [Likert Scale](http://en.wikipedia.org/wiki/Likert_scale).
    ...
    * [FLACC](http://en.wikipedia.org/wiki/FLACC_scale)
    ...
    <img src="faces.png" width="30%">

## Creating their own spreadsheet

Collaborate creation of data.  

Divide up into groups of 3 or 4.  Make a Google spreadsheet and share it with the other people in your group.  Enter some data about yourselves, including your email addresses, but also including a couple of categorical variables and a couple of quantitative variables.
