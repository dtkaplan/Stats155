...
This is a templace for the activity being introduced in class on *Starting R with Graphics*.  
* Your R code goes in the "chunks" offset by the 
<code>```{r}</code> fences.  So long as you follow the format in the examples, you'll be fine. (But you have to get the R statements right!)
...
It's up to you to construct the code for the other kinds of graphics, but here is a space to do it.

```{r}
# Replace this line with your density plot
```

Comments here

```{r}
# Replace this line with your box-and-whiskers plot.
```
