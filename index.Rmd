...
### Day-by-Day Links
  ...
  |  |  |  |   |   |    |  |  |   |  |  |   |  |
:-----:|:-----:|:-----|:-----:|---|---|---|---|---|---|---|---|---|---|
**Sept** |  `r DL(4,1)` | `r DL(6,2)` | `r DL(9,3)` | `r DL(11,4)` | `r DL(13,5)` | `r DL(16,6,style="dateToday")` | `r DL(18,7)` | `r DL(20,8)` |  `r DL(23,9)` | `r DL(25,10)` | `r DL(27,11)` | `r DL(30,12)` 
**Oct** | `r DL(2,13)` | `r DL(4,14)` | `r DL(7,15)` | `r DL(9,16)` | `r DL(11,17)` | `r DL(14,18)` | `r DL(16,19)` | <a href="#" class="tooltip"><em class="dateWarning">18</em><span><strong>Mid-term Exam</strong></span></a> | `r DL(21,21)` | `r DL(23,22)` | <a href="#" class="tooltip"><em >25</em><span><strong>Fall Break!</strong></span></a> | `r DL(28,23)` | `r DL(30,24)` |
...
Click on a date to see the syllabus/readings/assignments for that day.
