...
* The **RStudio Server** is [here](www.macalester.edu/rstudio).  Your ID is your Mac email prefix.  Your password is initialized to the last 4 digits of your student ID, e.g. ```jsmith```. [Instructions here](http://rpubs.com/dtkaplan/7981)
