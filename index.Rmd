...
**Oct** | `r DL(2,13)` | `r DL(4,14,style="dateToday")` Q | `r DL(7,15)` | `r DL(9,16)` | `r DL(11,17)` Q | `r DL(14,18)` | `r DL(16,19)` | <a href="#" class="tooltip"><em class="dateWarning">18</em><span><strong>Mid-term Exam</strong></span></a> | `r DL(21,21)` | `r DL(23,22)` | <a href="#" class="tooltip"><em >25</em><span><strong>Fall Break!</strong></span></a> | `r DL(28,23)` | `r DL(30,24)` |
