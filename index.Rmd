...
**Nov** | `r DL(1,25)` | `r DL(4,26)` | `r DL(6,27)` | `r DL(8,28)` | `r DL(11,29,)` | `r DL(13,30)` | `r DL(15,31,style="dateToday")` | `r DL(18,32)` | `r DL(20,33)` | `r DL(22,34)` | `r DL(25,35)` | `r DL(27,36)` | <a href="#" class="tooltip"><em>29</em><span><strong>Thanksgiving!</strong></span></a> | 
