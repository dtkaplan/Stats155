...
### Day-by-Day Links
  ...
  |  |  |  |   |   |    |  |  |   |  |  |   |  |
:-----:|:-----:|:-----|:-----:|---|---|---|---|---|---|---|---|---|---|
**Sept** |  `r DL(4,1)` | `r DL(6,2)` | `r DL(9,3)` | `r DL(11,4)` | `r DL(13,5,style="dateToday")` | `r DL(16,6)` | `r DL(18,7)` | `r DL(20,8)` |  `r DL(23,9)` | `r DL(25,10)` | `r DL(27,11)` | `r DL(30,12)` 
...
<iframe width='550' height='300' frameborder='0' src='https://docs.google.com/spreadsheet/pub?key=0Am13enSalO74dFIyT1JTRzhSV3UtMmZ5VGRUUGtKWnc&output=html&widget=true'></iframe>
